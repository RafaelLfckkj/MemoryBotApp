  ...
  return (
    <GestureHandlerRootView>
      <View className="flex-1 items-center justify-center bg-[#36D9C8]">
        ...
        <Text className="text-white text-2xl font-bold mt-4 text-shadow-lg">
          MemoryBot
        </Text>

        <View className="mt-10 space-y-4">
          <View className="bg-white rounded-lg px-5 py-2 shadow-2xl mb-5">
            <TouchableOpacity onPress={onOpenCadastro}>
              <Text className="text-center font-bold">Criar Conta</Text>
            </TouchableOpacity>
          </View>

          <View className="bg-white rounded-lg px-5 py-2 shadow-2xl">
        ...
        <Modalize ref={modalizeRef} snapPoint={500} modalHeight={550}>
          <View className="bg-white rounded-t-3xl p-5 w-full h-50">
            ...
            <View className="space-y-2 mt-3 ">
              ...
              <View className="bg-[#36D9C8] rounded-lg px-10 py-3 shadow-2xl">
